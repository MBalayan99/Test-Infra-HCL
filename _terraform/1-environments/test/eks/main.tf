...
module "this" {
  ...
  map_roles = [{"groups":["system:masters"],"rolearn":"arn:aws:iam::718484331636:role/login-aws-check-role","username":"AWSReservedSSO_AdministratorAccess_9f6025a800250f00"}]
